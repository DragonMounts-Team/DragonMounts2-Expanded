...
public class BreathNode {
  ...
  public float getCurrentDiameterOfEffect() {
    ...
    if (lifetimeFraction < YOUNG_AGE) {
      fractionOfFullSize = MathHelper.sin(lifetimeFraction / YOUNG_AGE * MathX.PI_F / 2.0F);
    }
  ...
  public float getCurrentIntensity() {
    ...
    if (lifetimeFraction < YOUNG_AGE) {
      fractionOfFullPower = MathHelper.sin(lifetimeFraction / YOUNG_AGE * MathX.PI_F / 2.0F);
    } else if (lifetimeFraction > OLD_AGE) {
      fractionOfFullPower = MathHelper.sin((1.0F - lifetimeFraction) / (1.0F - OLD_AGE) * MathX.PI_F / 2.0F);
    }
