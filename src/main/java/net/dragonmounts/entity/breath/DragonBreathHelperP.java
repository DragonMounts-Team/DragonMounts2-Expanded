...
import net.dragonmounts.entity.breath.nodes.BreathNodeFactory;
import net.dragonmounts.entity.breath.nodes.BreathProjectileFactory;
import net.dragonmounts.entity.breath.sound.SoundController;
import net.dragonmounts.entity.breath.sound.SoundEffectBreathWeaponP;
...
{
  public DragonBreathHelperP(TameableDragonEntity dragon, DataParameter<String> i_dataParamBreathWeaponTarget,
  ...
  public void refreshBreed(TameableDragonEntity dragon)
  {
  ...
  public void refreshBreedClientOnly(TameableDragonEntity dragon)
  {
