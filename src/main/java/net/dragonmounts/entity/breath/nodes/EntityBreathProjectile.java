...
import net.dragonmounts.entity.breath.sound.SoundEffectProjectile;
...
public abstract class EntityBreathProjectile extends Entity implements IEntityAdditionalSpawnData
{
  ...
  public EntityBreathProjectile(World worldIn, TameableDragonEntity shooter,
  ...
  public class SoundUpdateLink implements SoundEffectProjectile.ProjectileSoundUpdateLink
  {
    public boolean refreshSoundInfo(SoundEffectProjectile.ProjectileSoundInfo infoToUpdate)
    {
      ...
      TameableDragonEntity parentDragon = getParentDragon();
   ...
   */
  public TameableDragonEntity getParentDragon()
  {
    ...
    if (entityFromID instanceof TameableDragonEntity) {
      parentDragon = (TameableDragonEntity)entityFromID;
    }
    return parentDragon;
  }
  ...
  private TameableDragonEntity parentDragon;
