...
public class DMSounds {
	...
	public static final SoundEvent DRAGON_BREATH_START_FOREST;
	...
	public static final SoundEvent DRAGON_BREATH_LOOP_FOREST;
	...
	public static final SoundEvent DRAGON_BREATH_STOP_FOREST;
	...
	static {
		...
		list.add(DRAGON_BREATH_START_FOREST = create("entity.dragon.breath_start.forest"));
		...
		list.add(DRAGON_BREATH_LOOP_FOREST = create("entity.dragon.breath_loop.forest"));
		...
		list.add(DRAGON_BREATH_STOP_FOREST = create("entity.dragon.breath_stop.forest"));
