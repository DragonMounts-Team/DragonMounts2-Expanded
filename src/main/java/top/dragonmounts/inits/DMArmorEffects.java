...
import top.dragonmounts.api.IDescribableArmorEffect.Advanced;
import top.dragonmounts.capability.IArmorEffectManager;
import top.dragonmounts.network.SRiposteEffectPacket;
...
import static top.dragonmounts.DragonMounts.NETWORK_WRAPPER;
import static top.dragonmounts.DragonMounts.makeId;
import static top.dragonmounts.inits.DMCapabilities.ARMOR_EFFECT_MANAGER;
import static top.dragonmounts.util.EntityUtil.addOrMergeEffect;
import static top.dragonmounts.util.EntityUtil.addOrResetEffect;
