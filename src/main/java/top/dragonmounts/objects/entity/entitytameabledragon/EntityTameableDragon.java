 ...
 */
package top.dragonmounts.objects.entity.entitytameabledragon;

import top.dragonmounts.DragonMounts;
import top.dragonmounts.DragonMountsConfig;
import top.dragonmounts.DragonMountsLootTables;
...
import top.dragonmounts.inits.*;
import top.dragonmounts.inventory.DragonInventory;
import top.dragonmounts.network.MessageDragonBreath;
import top.dragonmounts.network.MessageDragonExtras;
...
import top.dragonmounts.objects.entity.entitytameabledragon.ai.ground.EntityAIDragonSit;
import top.dragonmounts.objects.entity.entitytameabledragon.ai.path.PathNavigateFlying;
import top.dragonmounts.objects.entity.entitytameabledragon.breath.DragonBreathHelper;
import top.dragonmounts.objects.entity.entitytameabledragon.breath.DragonBreathHelperP;
...
import top.dragonmounts.objects.entity.entitytameabledragon.helper.*;
import top.dragonmounts.objects.entity.entitytameabledragon.helper.*;
import top.dragonmounts.objects.entity.entitytameabledragon.helper.util.Pair;
import top.dragonmounts.objects.items.ItemDragonEssence;
import top.dragonmounts.objects.items.ItemDragonScales;
...
public class EntityTameableDragon extends EntityTameable implements IShearable, IEntityAdditionalSpawnData {
    ...
    private static final DataParameter<ItemStack> ARMOR = EntityDataManager.createKey(EntityTameableDragon.class, DataSerializers.ITEM_STACK);
    private static final DataParameter<ItemStack> CHEST = EntityDataManager.createKey(EntityTameableDragon.class, DataSerializers.ITEM_STACK);
    private static final DataParameter<ItemStack> SADDLE = EntityDataManager.createKey(EntityTameableDragon.class, DataSerializers.ITEM_STACK);
    @Deprecated
    ...
    protected void entityInit() {
        ...
        manager.register(ARMOR, ItemStack.EMPTY);
        manager.register(CHEST, ItemStack.EMPTY);
        manager.register(SADDLE, ItemStack.EMPTY);
    }
...
//      System.out.println("MountedOffset:" + mountedPositionOffset);
    ...
    public void onSaddleChange(ItemStack stack) {
        /*if (saddle.getItem() == Items.SADDLE && !saddle.isEmpty() && !isSaddled() && isOldEnoughToBreathe()) {
    ...
    public void setArmor(ItemStack armor) {
        this.getDataManager().set(ARMOR, armor);
    }

    public void setChest(ItemStack chest) {
        this.getDataManager().set(CHEST, chest);
    }

    public void setSaddle(ItemStack saddle) {
        this.getDataManager().set(SADDLE, saddle);
    }
