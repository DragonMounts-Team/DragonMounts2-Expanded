package top.dragonmounts.objects.entity.entitytameabledragon.breath.effects;
 ...
 *
 */
public class PoisonBreathFX extends ClientBreathNodeEntity {
    public static final ResourceLocation DRAGON_BREATH_TEXTURE = new ResourceLocation(DragonMountsTags.MOD_ID, "textures/entities/breath_poison.png");
     ...
     */
    public PoisonBreathFX(World world, Vec3d position, Vec3d direction, BreathNode.Power power, float partialTicksHeadStart) {
